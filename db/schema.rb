...
ActiveRecord::Schema[7.0].define(version: 2023_03_01_130109) do
  ...
  create_table "eventspaces", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    ...
    t.integer "price"
    t.text "description"
    t.index ["user_id"], name: "index_eventspaces_on_user_id"
  end
...
>>>>>>> ffe3ca4872d91021a591795b6dae00e76a30155d
